...
const Poderes = () => {
    /* 
       ...
       - nombre_poder: Nombre oficial del poder
       
       Rol en el sistema:
       Esta vista permite la lectura y actualización de los registros dentro del CRUD de poderes.
    */
                        ...
                        <div className="w-full p-8 lg:p-12 flex flex-col">
                            ...
                            <div className="border-b border-slate-100 pb-6 mb-6">
                                ...
                                <p className="text-slate-500 text-base mt-2 leading-relaxed">
                                    Detalles generales referentes a la entidad territorial registrada bajo la tabla dinámica de poderes.
                                </p>
                            </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex items-center justify-between p-4 bg-slate-50 border border-slate-200/80 rounded-2xl hover:border-slate-300 transition-all">
                                    <div className="flex items-center gap-3">
                                        <span className="w-2.5 h-2.5 rounded-full bg-blue-500"></span>
                                        <span className="font-mono text-base font-bold text-slate-700">codigo_poder</span>
                                    </div>
                                    <span className="text-xs font-semibold font-mono bg-white text-slate-600 px-3 py-1.5 rounded-xl border border-slate-200 shadow-sm">
                                        Numeric (2)     01, 02, 03, 04, 05, 06
                                    </span>
                                </div>
                                ...
                                <div className="flex items-center justify-between p-4 bg-slate-50 border border-slate-200/80 rounded-2xl hover:border-slate-300 transition-all">
                                    <div className="flex items-center gap-3">
                                        <span className="w-2.5 h-2.5 rounded-full bg-blue-500"></span>
                                        <span className="font-mono text-base font-bold text-slate-700">nombre_poder</span>
                                    </div>
                                    <span className="text-xs font-semibold font-mono bg-white text-slate-600 px-3 py-1.5 rounded-xl border border-slate-200 shadow-sm">
                                        Char (30)   (EJECUTIVO, LEGISLATIVO, JUDICIAL, CIUDADANO, ELECTORAL, ORGANOS INDEPENDIENTES O AUTONOMOS)
                                    </span>
                                </div>
                            </div>
